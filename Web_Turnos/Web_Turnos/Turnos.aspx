...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container border-light w-50 rowTop" style="padding-top: 3%;">
        ...
        <div class="row p-2 bg-white">
            <div class="col-12">
                <table id="tblTurnos" class="table table-hover text-center table-responsive-lg" style="width: 100%">
                    <thead>
                        <tr>
                            <th>Editar</th>
                            <th>Nro. Turno</th>
    ...
    <div id="divDatosTurno" class="container border-light w-50 rowTop" style="padding-top: 1%;" visible="false" runat="server">
        <div class="row rowTitle rowTop">
            <div class="col-12">
